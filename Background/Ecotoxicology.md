...
- Human and Non-human effects
- Harmful natural and anthropogenic substances
- Environmental affects -- broad sense.
...
Obesity is big problem, where we can measure "health" using the Body Mass Index: 

$BMI = Mass (kg)/Height^2 (m)$

or 

$BMI = 740 * (Mass (lb))/ (Height^2 (in))$
...
See Example Handout on 2-Way ANOVA
=======================================================
...
- Red pigmented poisonous algal blooms (Dinophyceae) 
...
+ Results in decrease in fish, algal blooms (and potentially toxic, Cyanophyta)
