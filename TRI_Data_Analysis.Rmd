...
Below is a screen shot but I forgot to check on the longitude and latitude, so be sure to add these categories. I also suggest you check all of the buttons on where this stuff is going.
